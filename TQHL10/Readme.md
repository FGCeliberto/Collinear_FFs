...
with Heavy and Light flavors", named $\mbox{\tt TQHL1.0}$ [1]. It was built by evolving à la DGLAP a Suzuki-like model input for the heavy-quark function [2][3]. Final LHAPDF grids (central value only) are evolved via the $\mbox{\tt AFPEL++}$ library [4].
